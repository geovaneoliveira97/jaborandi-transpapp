// src/pages/About.tsx
//
// Página Sobre — apresenta o propósito do app, o contexto acadêmico e o polo UNIVESP.
//
// É a única página totalmente estática do app: não busca dados do banco
// nem depende de estado externo, pois seu conteúdo não muda ao longo do tempo.
...
export default function About() {
  return (
    <div className="space-y-4 animate-enter">
      ...
      {/* Card principal com identidade do projeto */}
      <div className="card p-6 space-y-4 text-center">
        ...
        {/* Rodapé do card com vínculo acadêmico */}
      ...
      {/* Card do polo com ícone de localização */}
